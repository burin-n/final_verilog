...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(clk, reset, hsync, vsync, rgb, addr, enable, data)
/* synthesis syn_black_box black_box_pad_pin="clk,reset,hsync,vsync,rgb[11:0],addr[31:0],enable,data[31:0]" */;
  input clk;
  input reset;
  output hsync;
  output vsync;
